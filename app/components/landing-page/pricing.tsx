    ...
    return(
        <div className="my-[150px] flex flex-col items-center gap-14">
            <div className="flex flex-col items-center gap-6">
                ...
                <p className="text-context-body text-xl text-center">Junte-se à comunidade de programadores profissionais que ja estão elevando sua <br/>
                presença online. Teste gratuitamente por <strong className="text-accent-pink">{TRIAL_DAYS}</strong>, sem compromisso.</p>
            </div>
